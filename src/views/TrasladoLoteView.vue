      ...
      <main class="flex-1 bg-gray-800 p-4 flex flex-col space-y-4">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            ...
            <!-- Lote Origen -->
           <div>
            <label class="text-gray-300 text-sm mb-1 block">Lote Origen</label>
            <select v-model="formData.loteOrigen"
              ...
              <option value="" disabled selected>Seleccione Lote Origen</option>
